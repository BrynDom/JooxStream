...
async def _nightmode(_, message):
    return await message.reply_photo(photo="https://mallucampaign.in/images/img_1709026510.jpg", caption="**Silahkan klik tombol diatas mode malam mau di aktifkan apa tidak..**",reply_markup=buttons)
